...
export default function LoginPage() {
  ...
  const { login, loginWithGoogle, getRoleRoute } = useAuth();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-md w-full space-y-6 md:space-y-8 p-6 md:p-8 bg-white rounded-lg shadow-md animate-fadeIn">
        <div>
